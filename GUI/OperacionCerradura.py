...
def hacerCerradura(AFN, ventana, misAFNs):
    automata = misAFNs[int(AFN.get())]
    automataNuevo = automata.cerraduraKleene()
...
def creacionCerradura(misAFNs):
    ...
    #Boton
    boton = tk.Button(ventana, text="Realizar operación", command=lambda: hacerCerradura(listaAFN,ventana, misAFNs))
